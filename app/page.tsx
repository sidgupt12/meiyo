  ...
  return (
      ...
      <header className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 flex items-center justify-between px-8 py-2 backdrop-blur-xl bg-white/60 dark:bg-black/40 rounded-full border border-gray-200/50 dark:border-gray-600/70 shadow-lg dark:shadow-gray-700/50 w-auto max-w-6xl">
        <div className="flex items-center mr-4">
          ...
          <div className="w-4 h-4 bg-black dark:bg-white rounded-full ml-0.5"></div>
          <div className="w-4 h-4 bg-black dark:bg-white -ml-0.5" style={{clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)'}}></div>
        </div>
        ...
        <div className="flex items-center gap-2 ml-4">
          <ThemeToggle />
          <Button variant="outline" className="bg-black dark:bg-white text-white dark:text-black border-black dark:border-white hover:bg-gray-800 dark:hover:bg-gray-200 rounded-full px-3 py-1 text-xs">
            Start
          </Button>
        </div>
      </header>
      ...
      <div className="max-w-6xl mx-auto pt-20">
        ...
        <section className="px-8 py-16 lg:py-20">
          <div className="text-left">
            <h1 className="text-[40px] font-bold leading-tight mb-2 text-black dark:text-white transition-colors" style={{fontWeight: '700'}}>
              meiyo<span className="inline-block w-2 h-2 bg-black dark:bg-white rounded-full ml-1 mb-2"></span>
            </h1>
          ...
          {/* Large content area */}
          <div className="mt-16">
            <div className="w-full h-80 bg-gray-100 dark:bg-custom-white rounded-lg transition-colors"></div>
          </div>
        </section>
        ...
        <section id="works" className="px-8 py-16 text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.from({ length: 6 }).map((_, i) => (
              <div
                key={i}
                className="aspect-video bg-gray-100 dark:bg-custom-white rounded-lg hover:bg-gray-200 dark:hover:bg-gray-100 transition-colors cursor-pointer"
              ></div>
            ))}
          </div>
        </section>
        ...
        <section id="pricing" className="px-8 py-20 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-custom-card p-8 rounded-2xl transition-colors">
              ...
              <Button className="w-full bg-gray-200 dark:bg-custom-white text-gray-800 dark:text-black hover:bg-gray-300 dark:hover:bg-gray-100 border-0 rounded-full py-4 font-medium text-base transition-colors">
                Begin the journey
              </Button>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-custom-card p-8 rounded-2xl transition-colors">
              ...
              <Button className="w-full bg-gray-200 dark:bg-custom-white text-gray-800 dark:text-black hover:bg-gray-300 dark:hover:bg-gray-100 border-0 rounded-full py-4 font-medium text-base mt-[1.625rem] transition-colors">
                Sustain and grow
              </Button>
            </div>
          </div>
        ...
        <section id="faq" className="px-8 py-16">
          <div className="space-y-4 max-w-4xl mx-auto">
            <Collapsible>
              <CollapsibleTrigger className="flex items-center justify-between w-full p-4 bg-gray-100 dark:bg-custom-card rounded-lg text-left hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors">
              ...
              <CollapsibleContent className="p-4 bg-gray-50 dark:bg-custom-card text-gray-600 dark:text-custom-gray transition-colors rounded-b-lg border-t border-gray-200 dark:border-gray-700">
        ...
        <footer id="contact" className="px-8 py-16 border-t border-gray-200 dark:border-gray-800 transition-colors">
          <div className="flex flex-col lg:flex-row justify-between gap-12">
            <div className="flex items-center">
              <div className="w-4 h-4 bg-black dark:bg-white"></div>
              <div className="w-4 h-4 bg-black dark:bg-white rounded-full ml-0.5"></div>
              <div className="w-4 h-4 bg-black dark:bg-white -ml-0.4" style={{clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)'}}></div>
            </div>
